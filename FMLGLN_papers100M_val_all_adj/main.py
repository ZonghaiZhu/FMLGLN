...
def main():
    ...
    feats_vv1 = feats_1[valid_idx]
    del feats_1

    feats_3 = adj @ feats_2
    feats_tv2 = feats_2[train_idx]
    feats_vv2 = feats_2[valid_idx]
    del feats_2

    # feats_4 = adj @ feats_3
    feats_tv3 = feats_3[train_idx]
    feats_vv3 = feats_3[valid_idx]
    del feats_3

    # feats_tv4 = feats_4[train_idx]
    # feats_vv4 = feats_4[valid_idx]
    # del feats_4
    del adj
    ...
    if args.single_class:
        targets_tst = y[valid_idx].view(-1)
    else:
        targets_tst = np.vstack([y[i] for i in valid_idx])
